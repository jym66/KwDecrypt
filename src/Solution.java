class Solution {
    public static void main(String[] args) {
        ...
        String rid = "142655450";
//        System.out.println(getParams(rid));
        String Baseurl = "http://nmobi.kuwo.cn/mobi.s?f=kuwo&q=" + getParams(rid);
        System.out.println(HttpUtil.doGet(Baseurl));
    }
    ...
    public static String getParams(String rid) {
        ...
        byte[] a3 = d.a(bytes, bytes.length, d.f8946a);
